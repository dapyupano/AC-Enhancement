...
NEGATIVE_CONTEXT = {
    ...
    "PT": {"PART-TIME", "PARTTIME", "POINT", "PATROL", "PLAYTIME", "PACIFIC", "PRIME"},
...
POSITIVE_CONTEXT = {
    ...
    "PT": {
         "ADMITTED", "PAIN", "AGE", "DIAGNOSIS", "DISCHARGED", "FEMALE", "FOLLOWUP",
         "HISTORY", "MALE", "MEDICATION", "PATIENT", "PATIENTS", "SYMPTOMS",
         "VISIT", "REPORTS", "ABDOMINAL",  "BP", "HR", "TEMP", 
         "WEIGHT", "PREGNANCY", "PREGNANT", "HCG", "LMP", "GESTATION", "URINE",
         "TRIMESTER", "OB", "BLEEDING", "CLOTTING", "COAGULATION", "INR", "WARFARIN",
         "PTT",  "NAUSEA",
    },
...
COMMON_ENGLISH_WORDS = {
    ...
    "VIA", "VIAL",
    "CUP", "CUPS", "MIX", "MIXED", "MIXING", "DAY", "DAYS",
    "AND", "FOR", "THE", "WITH", "FROM", "INTO", "ONTO", "OVER", "AFTER",
    "BEFORE", "DURING", "WHILE", "WHEN", "THEN", "THAN", "THAT", "THIS",
    "THESE", "THOSE", "TAKE", "TAKEN", "TAKING", "GIVE", "GIVEN", "GIVING",
    "STOP", "STOPS", "STOPPED", "PUSH", "PUSHED", "PUSHING", "DRIP",
    "LINE", "FLUID", "FLUIDS", "SALINE", "PATIENT", "REPORTS", "REPORT",
    "ADMIT", "ADMITTED", "PAIN", "NAUSEA", "ABDOMINAL", "INFUSION",
    "PERIPHERAL", "NEEDED", "DAILY", "ONCE", "TWICE", "EACH", "EVERY",
    "ORAL", "ORALLY", "TABLET", "TABLETS", "DOSE", "DOSAGE"
    "DROPS", "JOINT",
}